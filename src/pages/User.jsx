...
const User = () => {
    ...
    return (
        <div className='min-h-screen bg-login-form '>
            ...
            <div className='container '>
                ...
                <div className='fixed top-5 hidden md:block'>
                    <Link to={'/'} className='flex flex-row-reverse gap-x-2 text-primaryRed'>
                        <span>Back To Home </span>
                        <img src={arrowLeft} alt="arrowLeft" />
                    </Link>
                </div>

                <div className='md:w-1/2 md:flex md:items-center md:justify-center min-h-screen md:pt-12'>
                        ...
                        <Tab.Group onChange={setSelectedIndex}>
                            ...
                            <Tab.List className="flex space-x-1 rounded-xl bg-primaryRed/20 p-1">
                                ...
                                className={({ selected }) =>
                                    ...
                                    selected
                                        ? 'bg-white shadow'
                                        : 'text-primaryRed md:text-white hover:bg-white/[0.12] hover:text-white'
                                    )
                                }
                                >
                                    Login
                            ...
                            <Tab.Panels className="mt-8" id='user'>
                                ...
                                <Tab.Panel className=''>
                                    <div>
                                        ...
                                        >
                                            ...
                                            {({errors, values, touched, }) => (
                                                ...
                                                <Form className='flex flex-col justify-center h-full relative bg-form gap-y-4'>
                                                    ...
                                                    {errors.email && touched.email && <span className='bg-red-600 shadow-button shadow-red-500 text-gray-200 rounded-lg px-3 py-0.5 text-sm md:text-base'>{errors.email}</span>}
                                                    ...
                                                    {errors.password && touched.password && <span className='bg-red-600 shadow-button shadow-red-500 text-gray-200 rounded-lg px-3 py-0.5 text-sm md:text-base'>{errors.password}</span>}
                                        ...
                                        <div className="shape1 md:hidden bottom-[100px] right-0"></div>
                                        <div className="shape2 md:hidden top-[200px] left-[-100px]"></div>
                                    </div>
                                        ...
                                        >
                                            ...
                                            {({errors, values, touched }) => (
                                                ...
                                                <Form className='flex flex-col justify-center h-full relative bg-form gap-y-4'>
                                                    ...
                                                    {errors.name && touched.name && <span className='bg-red-600 shadow-button shadow-red-500 text-gray-200 rounded-lg px-3 py-0.5 text-sm md:text-base'>{errors.name}</span>}
                                                    ...
                                                    {errors.confirmPassword && touched.confirmPassword && <span className='bg-red-600 shadow-button shadow-red-500 text-gray-200 rounded-lg px-3 py-0.5 text-sm md:text-base'>{errors.confirmPassword}</span>}
                                                    ...
                                                    {errors.checkbox && touched.checkbox && <span className='bg-red-600 shadow-button shadow-red-500 text-gray-200 rounded-lg px-3 py-0.5 text- md:text-lg'>{errors.checkbox}</span>}
